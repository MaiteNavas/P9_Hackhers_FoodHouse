...
class FotoController extends Controller
{
    public function obtenerRutasFotos()
    {
        return [
            'categorias/Carnes.jpeg',
            'categorias/Desayunos.jpeg',
            'categorias/Ensaladas.jpg',
            'categorias/Entrantes.jpg',
            'categorias/Pastas.jpeg',
            'categorias/Pescados.webp',
            'categorias/Postres.webp',
            'categorias/Bebidas.jpg',
        ];
    }
}
